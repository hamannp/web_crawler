class ListingMaker
  ...
  #purposes or to stuff data into something that would be more sane, like
  #Monogodb.
  def perform(page, detail_class_name=DetailPage.name)
    ...
    # If it fails to process at this point, then something about the page changed.
    # I think it makes more sense to log it and then investigate what could be done to
    # improve the crawler.
